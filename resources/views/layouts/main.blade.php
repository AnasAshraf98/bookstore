...
<head>
    ...
    <!-- fontawesome -->
    <script src="https://kit.fontawesome.com/7c45ac732b.js" crossorigin="anonymous"></script>
    <style>
        .score{
            display: block;
            font-size: 16px;
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('cart.view')}}">
                                    ...
                                    @endif
                                            العربة
                                    <li style="margin-top: 12px" class="fas fa-shopping-cart"></li>
                                </a>
                            </li>
                        @endauth
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('gallery.categories.index')}}">
                                        التصنيفات
                                <li style="margin-top: 12px" class="fas fa-list"></li>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('gallery.publishers.index')}}">
                                        الناشرون
                                <li style="margin-top: 12px" class="fas fa-table"></li>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('gallery.authors.index')}}">
                                        الناشرون
                                <li style="margin-top: 12px" class="fas fa-pen"></li>
                            </a>
                        </li>
